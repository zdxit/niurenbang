		...
		<div class="nav">
				...
				<div class="login right">
					<c:choose>
						<c:when test="${user==null}">
							<a href="javascript:void(0);" action="login" id="login">登录</a>
							<a href="<%=path%>/to/register">注册</a>
				...
				<c:otherwise>
					<div class="top-admin">
						...
						<div class="login-info-box login-info-hover-action"
							id="login-info-box">
							<a href="<%=path%>/set/headimg" class="uc-admin"><img
			...
			$(document).ready(function () {
				$(".login-info-hover-action").hover(
					...
					function EnterPress() {
						if (event.keyCode === 13) {
							window.location.href = "<%=path%>/project/index/key/"+ $("#searchkeybox").val();
		...
		<c:otherwise>
			...
			<form name="login-dialog-form" id="login-dialog-form"
				...
				<div class="loginkuang" id="login-dialog">
					...
					<p>
						还没有账号?<a href="<%=path%>/to/register">立即注册</a>
					</p>
				</div>
			</form>
